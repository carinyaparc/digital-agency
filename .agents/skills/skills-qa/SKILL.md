...
| Framework reference | Read `.agents/references/agency-skill-design-framework.md` |
...
Read `.agents/references/agency-skill-design-framework.md` for definitions. For each
