...
This plugin ships a bundled `.mcp.json` with common SaaS connectors. You can also install standalone connector plugins from `connectors/` in this repo (GitHub, GitLab, Vercel, Linear, Figma, and others).
