...
For eval runs on skills in this repo, use **eval-grader** from `.agents/agents/eval-grader.md`. Run **skills-qa** from `.agents/skills/skills-qa/SKILL.md` before shipping skill changes.
