...
Each agent plugin under `plugins/agents/<slug>/` will get a matching cookbook here:

| Agent | Practice | Headless use |
| ----- | -------- | ------------ |
| `frontend-engineer` | Engineering | Implement UI tasks against approved design and tasks |
| `senior-frontend-engineer` | Engineering | Peer code review before MR creation |
